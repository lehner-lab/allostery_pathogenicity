...
write.csv(final_merged_df,
          "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/cleaned/megascale_esm1v_64_proteingym.csv",
          row.names = FALSE)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig1_domains_r2.pdf", 
...
```{r}
nrow(pdb_map %>% filter(!From %in% c("1URF","1I6C","2WQG","1W4G","1TUD","1YU5","3L1X","7JJK")) %>% filter(Organism == "Homo sapiens (Human)"))
