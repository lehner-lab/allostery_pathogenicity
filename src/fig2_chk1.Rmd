...
chk1_pred <- analyze_ddg_vs_esm1v(
  ddg_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/CHK1/AF-O14757-F1-model_v4.csv",
...
p0 <- chk1_pred$plot
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_chk1_p0.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_chk1_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/CHK1/2e9n.pdb",
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/CHK1/2e9n_loess_residual.pdb"
)
...
pdb <- read.pdb("~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/CHK1/2e9n.pdb", rm.alt = TRUE)

protein_ca <- pdb$atom[pdb$atom$elety == "CA" & pdb$atom$resid != "76A"  & pdb$atom$resid != "HOH", ]

ligand_atoms <- pdb$atom[pdb$atom$resid == "76A" & pdb$atom$type == "HETATM", ]
...
merged_df <- merge(chk1_pred_residual$data, protein_ca, by.x = "new_position", by.y = "resno") %>%
...
#orthosteric_sites <- c(15,23,36,38,84,87,137,148)
orthosteric_sites <- c(15,  16,  23 , 36 , 38 , 55,  59 , 68 , 84 , 85 , 86,  87 , 88 , 89 , 90 , 91,  94 ,137 ,147 ,148 ,149 ,150)

ortho_cutoff <- max(merged_df_residue %>% filter(new_position %in% orthosteric_sites) %>% pull(min_dist_to_ligand)) #6.620765
#merged_df_residue %>% filter(min_dist_to_ligand <= ortho_cutoff) %>% pull(new_position)
#15,  16,  23 , 36 , 38 , 55,  59 , 68 , 84 , 85 , 86,  87 , 88 , 89 , 90 , 91,  94 ,137 ,147 ,148 ,149 ,150
...
# Parameter a (intercept): 5.14212 4.208223 6.076017 
# Parameter b (decay rate): 0.04360793 0.0309415 0.05627436 
# Half-distance (log(2)/b): 15.89498 11.98191 22.87122 
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_chk1_p2.pdf", 
...
# -2.5097 -0.4733  0.1012  0.5963  1.6058 
# 
# Coefficients:
#                     Estimate Std. Error t value Pr(>|t|)    
# (Intercept)         1.292942   0.120126  10.763   <2e-16 ***
# min_dist_to_ligand -0.039685   0.006223  -6.378    8e-10 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.8153 on 264 degrees of freedom
# Multiple R-squared:  0.1335,	Adjusted R-squared:  0.1302 
# F-statistic: 40.67 on 1 and 264 DF,  p-value: 8.004e-10
```
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none")
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_chk1_p3.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_chk1_p4.pdf", 
