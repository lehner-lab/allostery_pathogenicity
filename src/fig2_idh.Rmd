...
idh_pred <- analyze_ddg_vs_esm1v(
  ddg_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/IDH/AF-O75874-F1-model_v4.csv",
...
p0 <- idh_pred$plot
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_idh_p0.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_idh_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/IDH/6io0.pdb",
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/IDH/6io0_loess_residual.pdb"
)
...
pdb <- read.pdb("~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/IDH/6io0.pdb", rm.alt = TRUE)
...
ortho_cutoff <- max(merged_df_residue %>% filter(new_position %in% orthosteric_sites) %>% pull(min_dist_to_ligand)) # 11.925
ortho_cutoff

unique(merged_df_residue %>% filter(min_dist_to_ligand <= ortho_cutoff) %>% pull(new_position))
#15,  16,  17,  18,  19,  21 , 22,  23,  44,  45,  71 , 72 , 73 , 74 , 75 , 76 , 77 , 78 , 79,  80,  81,  82,  83 , 85 , 86 , 91 , 92,  93 , 94 , 95 , 96,  97,  98,  99 ,100, 107, 109, 121, 122, 123, 252,253 ,254, 255, 256, 257, 258, 259, 260 ,276 ,279 ,280 ,281, 282, 283 ,284, 285, 286 ,287, 288 ,289 ,291 ,292 ,293, 294, 295 ,304 ,305 ,306 ,307 ,308, 309, 310, 311, 312, 313, 314, 315 ,316, 317, 325, 326,327, 328 ,329, 330 ,331 ,332, 333 ,334 ,335 ,372, 373, 374 ,375 ,376, 377, 393, 394, 397

orthosteric_sites <- c(15,  16,  17,  18,  19,  21 , 22,  23,  44,  45,  71 , 72 , 73 , 74 , 75 , 76 , 77 , 78 , 79,  80,  81,  82,  83 , 85 , 86 , 91 , 92,  93 , 94 , 95 , 96,  97,  98,  99 ,100, 107, 109, 121, 122, 123, 252,253 ,254, 255, 256, 257, 258, 259, 260 ,276 ,279 ,280 ,281, 282, 283 ,284, 285, 286 ,287, 288 ,289 ,291 ,292 ,293, 294, 295 ,304 ,305 ,306 ,307 ,308, 309, 310, 311, 312, 313, 314, 315 ,316, 317, 325, 326,327, 328 ,329, 330 ,331 ,332, 333 ,334 ,335 ,372, 373, 374 ,375 ,376, 377, 393, 394, 397)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_idh_p2.pdf", 
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none")
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_idh_p3.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_idh_p4.pdf", 
