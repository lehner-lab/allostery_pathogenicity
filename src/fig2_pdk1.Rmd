...
pdk1_pred <- analyze_ddg_vs_esm1v(
  ddg_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/PDK1/AF-O15530-F1-model_v4.csv",
...
p0 <- pdk1_pred$plot
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_pdk1_p0.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_pdk1_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/PDK1/4rqk.pdb",
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/PDK1/4rqk_loess_residual.pdb"
)
...
pdb <- read.pdb("~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb_3/PDK1/4rqk.pdb", rm.alt = TRUE)
...
# Parameter a (intercept): 7.554791 6.29253 8.817051 
# Parameter b (decay rate): 0.05642681 0.04395548 0.06889813 
# Half-distance (log(2)/b): 12.28401 9.813963 15.83984 
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_pdk1_p2.pdf", 
...
# -6.1926 -0.4784  0.0495  0.6327  1.4982 
# 
# Coefficients:
#                     Estimate Std. Error t value Pr(>|t|)    
# (Intercept)         1.626892   0.128425  12.668  < 2e-16 ***
# min_dist_to_ligand -0.048941   0.006843  -7.152 7.56e-12 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.8406 on 279 degrees of freedom
# Multiple R-squared:  0.1549,	Adjusted R-squared:  0.1519 
# F-statistic: 51.14 on 1 and 279 DF,  p-value: 7.555e-12
```
```{r, fig.width=5, fig.height=5}
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none")
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_pdk1_p3.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig2_pdk1_p4.pdf", 
