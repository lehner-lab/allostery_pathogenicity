...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3E_1.pdf", 
...
pdz3_out <- doubledeepms__minimum_interchain_distances_from_PDB_perres(
  input_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/structures/raw_pdb/1be9.pdb",
  chain_query = "A",
  chain_target = "B"
)
...
library(bio3d)
pdb <- read.pdb("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/structures/raw_pdb/1be9.pdb")
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3B_1.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3C.pdf", 
...
legend
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3B_legend.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/figS3B_1.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3D.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/figS3C.pdf", 
...
```{r}
sh3_final_df_ddgf <- read_tsv('/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/paper_supplements/domains_andre/Data/fitness/GRB2-SH3/Abundance/mochi_project/task_1/weights/weights_Folding.txt')
sh3_final_df_ddgf <- sh3_final_df_ddgf %>% dplyr::select(id_ref, Pos_ref, `mean_kcal/mol`, `std_kcal/mol`)
dim(sh3_final_df_ddgf) #1057    4

sh3_final_df_ddgb <- read_tsv('/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/paper_supplements/domains_andre/Data/fitness/GRB2-SH3/Abundance/mochi_project/task_1/weights/weights_Binding.txt')
...
pdb <- read.pdb("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/structures/raw_pdb/2vwf.pdb")
data <- median_residuals
head(data)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3B_2.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3B_2_legend.pdf", 
       plot = figS3A, width = 12, height = 3, dpi = 300)
```


```{r}
legend2 <- ggplot(sh3_final_df_ddg_2plot_other, aes(x = f_ddg_pred, y = ESM1v, color = residuals)) +
  geom_point(size = 2, alpha = 0.35) +
  #geom_vline(xintercept = 0.71, linetype = "dashed", linewidth = 0.5, color = "grey") +
  #geom_hline(yintercept = -1.11, linetype = "dashed", linewidth = 0.5, color = "grey") +
  geom_line(data = fit_line_df, aes(x = f_ddg_pred, y = ESM1v),
            inherit.aes = FALSE, color = "black", linewidth = 0.8) +
  labs(
    title = "612 Other Mutations",
    subtitle = "Spearman's rho = -0.72",
    x = "Measured ddGf",
    y = "ESM1v",
    color = "Residuals"
  ) +
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version3/fig3_scatter2_legend_loess.pdf", 
       plot = legend2, width = 5, height = 4, dpi = 300)
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3C_2.pdf", 
       plot = fig3C, width = 3, height = 3, dpi = 300)
fig3C
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3E_2.pdf", 
       plot = fig3E, width = 8, height = 4, dpi = 300)
fig3E
```
...
sh3_out <- doubledeepms__minimum_interchain_distances_from_PDB_perres(
  input_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/structures/raw_pdb/2vwf.pdb",
  chain_query = "A",
  chain_target = "B"
)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/figS3B_2.pdf", 
       plot = p1, width = 4, height = 4, dpi = 300)
p1
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/fig3D_2.pdf", 
       plot = p2, width = 4, height = 4, dpi = 300)
p2
```
```{r}
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/version4/figS3C_2.pdf", 
       plot = figS3E, width = 4, height = 5, dpi = 300)
figS3E
