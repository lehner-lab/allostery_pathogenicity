...
#color sel dim grey
#select @@bfactor<999 
#color byattribute a:bfactor #1 & sel target csab palette -4.1,red:0,grey:1.9,blue
#select ::name="TLA"
...
custom_colors <- c(
  "gnomAD"     = "grey",  # Teal green (unchanged)
  "Somatic"    = "tomato3",  # Soft sky blue
  "Pathogenic" = "firebrick3"   # Deep ocean blue
)
