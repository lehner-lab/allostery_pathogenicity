---
title: "revision_fig2_gck_am.Rmd"
...
gck_pred <- analyze_ddg_vs_am(
  ddg_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb/GCK/AF-P35557-F1-model_v4.csv",
  am_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/revision/fig2_am/P35557.csv",
  protein_name = "GCK"
)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_gck_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb/GCK/1v4s_loess_residual_am_logit.pdb"
)

print(pdb_residual)

#chimerax
#color byattribute a:bfactor #1 & sel target csab palette -8.1,red:0,white:3.7,blue
```
```{r, fig.width=5, fig.height=5}
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_gck_p2.pdf", 
...
# -4.6983 -0.3909  0.0968  0.5223  1.7409 
# 
# Coefficients:
#                     Estimate Std. Error t value Pr(>|t|)    
# (Intercept)         1.014485   0.106233    9.55   <2e-16 ***
# min_dist_to_ligand -0.052956   0.005171  -10.24   <2e-16 ***
# ---
# Signif. codes:  0 ‘***’ 0.001 ‘**’ 0.01 ‘*’ 0.05 ‘.’ 0.1 ‘ ’ 1
# 
# Residual standard error: 0.7791 on 406 degrees of freedom
# Multiple R-squared:  0.2053,	Adjusted R-squared:  0.2033 
# F-statistic: 104.9 on 1 and 406 DF,  p-value: < 2.2e-16
```
```{r, fig.width=5, fig.height=5}
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none") 
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_gck_p3.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_gck_p4.pdf", 
