---
title: "revision_fig2_pdk1_am.Rmd"
...
pdk1_pred <- analyze_ddg_vs_am(
  ...
  am_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/revision/fig2_am/O15530.csv",
  protein_name = "pdk1"
)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_pdk1_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb/PDK1/4rqk_loess_residual_am_logit.pdb"
)

print(pdb_residual)

#chimerax
#color byattribute a:bfactor #5 & sel target csab palette -9.3,red:0,white:5.3,blue
```
```{r, fig.width=5, fig.height=5}
...
protein_ca <- pdb$atom[pdb$atom$elety == "CA" & pdb$atom$resid != "EPE" & pdb$atom$resid != "R1S" & pdb$atom$resid != "GOL" & pdb$atom$resid != "ATP" & pdb$atom$resid != "HOH", ]

ligand_atoms <- pdb$atom[pdb$atom$resid == "ATP" & pdb$atom$type == "HETATM", ]
...
merged_df <- merge(pdk1_pred_residual$data, protein_ca, by.x = "new_position", by.y = "resno") %>%
...
#orthosteric_sites <- c(89,91,92,94,96,109,111,160,162,166,212)
orthosteric_sites <- c(88 , 89,  90,  91,  92,  93,  94 , 95,  96 ,109, 111, 143 ,159, 160, 161, 162, 165 ,166, 209, 210, 212,223)

#ortho_cutoff <- max(merged_df_residue %>% filter(new_position %in% orthosteric_sites) %>% pull(min_dist_to_ligand)) #6.429171
#merged_df_residue %>% filter(min_dist_to_ligand <= ortho_cutoff) %>% pull(new_position)
#88 , 89,  90,  91,  92,  93,  94 , 95,  96 ,109, 111, 143 ,159, 160, 161, 162, 165 ,166, 209, 210, 212,223
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_pdk1_p2.pdf", 
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none")
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_pdk1_p3.pdf", 
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_pdk1_p4.pdf", 
