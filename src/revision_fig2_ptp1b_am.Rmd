---
title: "revision_fig2_ptp1b_am.Rmd"
...
ptp1b_pred <- analyze_ddg_vs_am(
  ddg_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb/PTP1B/AF-P18031-F1-model_v4.csv",
  am_file = "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/revision/fig2_am/P18031.csv",
  protein_name = "PTP1B"
)
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_ptp1b_p1.pdf", 
...
pdb_residual <- map_loess_residuals_to_pdb(
  ...
  output_pdb_path = "~/Documents/0.Projects/01.protein-seq-evo-v1/data/decay_pdb//PTP1B/1pty_loess_residual_am_logit.pdb"
)

print(pdb_residual)

#chimerax
#color byattribute a:bfactor #1 & sel target csab palette -9,red:0,white:4.9,blue
```
```{r, fig.width=5, fig.height=5}
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_ptp1b_p2.pdf", 
...
p3 <- ggplot(merged_df_residue, aes(x = site_class, y = abs(loess_residual_avg), fill = site_class)) +
  ...
  theme_classic() +
  theme(legend.position = "none")
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_ptp1b_p3.pdf", 
...
p4 <- ggplot(plot_df, aes(x = site_class, y = median_resid, fill = site_class)) +
 ...
 geom_text(
  ...
  labs(
    ...
    subtitle = "",
    x = "",
    y = "|Median residual (AM_logit - ddGf)|"
  ) +
  scale_fill_manual(values = c(
    "orthosteric" = "orange",
    "allosteric" = "cyan",
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig2_ptp1b_p4.pdf", 
