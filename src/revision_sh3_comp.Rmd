---
title: "SH3 — Per-Residue ddGb Correlation Analysis"
...
Load MoCHI-inferred folding free energy changes (ddGf) for GRB2-SH3 variants.
...
Aggregate per-residue median residuals, annotate site types, and test correlations stratified by site type.
...
Compare measured folding ddG against ESM-1v and ThermoMPNN ddGf at the variant level, colored by binding ddG.
...
# Per-Residue Deviance Plots

Aggregate per-residue medians and plot ThermoMPNN ddGf and ESM-1v correlations with measured folding ddG.
...
write_csv(test_merged_df_residue, "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/source_data/figs8d_sh3.csv")
