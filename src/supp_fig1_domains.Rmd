...
megascale_df <- data %>%
  ...
  group_by(WT_name) %>%
  mutate(wt_seq = dplyr::first(aa_seq[mut_type == "wt"])) %>%
  ungroup()
```
...
```{r}
write_csv(r2_combined, "/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/data/source_data/figs1d1.csv")
```
...
ggsave("/Users/xl7/Documents/0.Projects/01.protein-seq-evo-v1/figs/revision/fig1_domains_clinvar.pdf",
