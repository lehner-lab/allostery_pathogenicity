...
p5 <- ggplot(core_df_three_star_summary_df, aes(x = clinvar_clinical_significance, y = percent, fill = stability)) +
  ...
  labs(title = "3-star Core Variants", subtitle = "1974 ClinVar Variants",
       x = NULL, y = "Variant percentage (%)", fill = NULL) +
  theme_classic() + ylim(0, 100) +
  theme(legend.position = "bottom",
        plot.title = element_text(size = 24, hjust = 0, face = "bold"),
...
ggsave("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/allostery_pathogenicity/git_allostery_pathogenicity/figs/revision/fig1_clinvar_threestar.pdf", plot = p3, width = 12, height = 7, dpi = 500)
p6
```
...
ggsave("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/allostery_pathogenicity/git_allostery_pathogenicity/figs/revision/fig1_clinvar_plddt70.pdf", plot = p3, width = 12, height = 7, dpi = 500)
p9
```

```{r}
all_var_r2 <- read.csv("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/allostery_pathogenicity/git_allostery_pathogenicity/data/proteome_meta/all_var_lm_r2.csv")
...
ggsave("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/allostery_pathogenicity/git_allostery_pathogenicity/figs/panels/fig1_r2.pdf", plot = p1, width = 5, height = 4, dpi = 300)
...
ggsave("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/allostery_pathogenicity/git_allostery_pathogenicity/figs/panels/fig1_r2_protein_type.pdf", plot = p6, width = 10, height = 5, dpi = 300)
p6
```
