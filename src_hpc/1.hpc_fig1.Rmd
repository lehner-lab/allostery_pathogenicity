...
```{r}
all_var_r2 <- read.csv("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/00.human_proteome_results/all_var_lm_r2.csv")
...
core_var_r2 <- read.csv("/lustre/scratch126/gengen/projects_v2/alpha-allostery-global/00.human_proteome_results/core_lm_r2.csv")
